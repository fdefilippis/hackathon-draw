...
/**
 * Partecipanti presenti all'hackathon: invitati con "ok" nella colonna
 * Presente della lista "Invitati Hackaton", con i nomi normalizzati
 * sulla base del foglio anagrafico dell'invito.
...
const PARTICIPANTS = [
  ...
  "Roberto Sgobio",
  "Manuel Bisanti",
  "Maria Sofia Iacopinelli",
  "Fabio Sgambetterra",
  "Valentina Truncellito",
  "Jessica Tesconi",
];
